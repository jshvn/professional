...
\cventry
    ...
    {Developed an automated testing platform using commodity hardware and a pan-tilt servo system for real-world RF tests.} % Overall description
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
...
\cventry
    ...
    {Built an automated firmware verification system and developed tooling frameworks for the GalilSuite application.} % Overall description
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
