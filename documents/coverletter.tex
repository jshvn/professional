...
% Cover letter specific variables (after personal.tex to access \myposition)
\newcommand{\jobTitle}{<job title>}
\newcommand{\companyName}{<company>}

% PDF Metadata for cover letter (must be after personal.tex to access name variables)
\setupPDFMetadata{Cover Letter}{\myposition}
...
\makecvfooter
  {\today}
  {\myfullname{\enskip•\enskip}Written in {\LaTeX{}}{\enskip•\enskip}\gitAbbrevHash{} on \gitBranch}
  {}
