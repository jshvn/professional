...
\cventry
    ...
    {Implemented a KPI reporting and analytics system for DC mobile apps, including data engineering and an automated alert system for detected issues.} % Overall description
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
