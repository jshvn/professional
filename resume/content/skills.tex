...
%---------------------------------------------------------
  \cvskill
    {Tools} % Category
    {MLflow, Tensorflow, Scikit-learn, Tableau, VSCode, AWS (s3, ec2), DO, git, Docker, k8s, Hadoop \& Spark} % Skills
...
%---------------------------------------------------------
  \cvskill
    {Techniques} % Category
    {Conjoint analysis, ARIMA, STL decomposition, PCA, AB testing, ETL, CI/CD} % Skills
